...
- загрузка одного пользовательского изображения (GIF, PNG, JPG, WEBP или BMP);
- клик по скелету меняет его цвет случайным образом;
- выбор цвета скелета вручную в настройках и переключатель окраски изображения;
...
Готовый файл появится в `release/DeadLine-1.0.2-portable.exe`. Его также можно скачать из раздела [Releases](https://github.com/BulatReznik/DeadLine/releases/latest). Он запускается на Windows без Node.js, npm и открытого консольного окна.
