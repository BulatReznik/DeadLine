...
Готовый файл появится в `release/DeadLine-1.0.1-portable.exe`. Его также можно скачать из раздела [Releases](https://github.com/BulatReznik/DeadLine/releases/latest). Он запускается на Windows без Node.js, npm и открытого консольного окна.
